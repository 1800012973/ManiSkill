...
python -m tools.run_rl configs/bc/Pointnet2.py --gpu-ids=3 \
	--work-dir=./work_dirs/bc_Pointnet2_lrdecay/ \
	--cfg-options "train_mfrl_cfg.total_steps=900000" "train_mfrl_cfg.init_replay_buffers=" \
	"train_mfrl_cfg.init_replay_with_split=[\"./full_mani_skill_data/OpenCabinetDrawer1/\",\"$model_list\"]" \
