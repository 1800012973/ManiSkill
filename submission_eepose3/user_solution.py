...
class UserPolicy(BasePolicy):
    def __init__(self, env_name):
        ...
        cfg_path = str(pathlib.Path('./configs/bc/mani_skill_point_cloud_transformer_WOGlobal.py').resolve())
        #cfg_path = './configs/bc/EEPose2.py'
    ...
    def act(self, observation):
        ...
        return to_np(self.agent(unsqueeze(observation, axis=0), mode='eval')[0])[0]
